package com.hover.management.config.jobautoconf;
...
public class QuartzJobAutoConfig {
    ...
    public Object jobDetailGenerates() {
        SpringContextHolder.getBean("exampleThreadPool");
        ...
        quartzTaskInfo.setCronExpression("0 0/1 * * * ?");
        //job 名称k
    ...
    **/
    ...
    public ThreadPoolTaskExecutor getExampleThreadTask()
    {
