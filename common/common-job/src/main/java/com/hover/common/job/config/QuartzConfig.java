package com.hover.common.job.config;
...
public class QuartzConfig {
    ...
    @Bean
    public QuartzScheduleService quartzScheduleService(SpringContextHolder springContextHolder) {
    ...
    public Properties quartzProperties() throws IOException {
         ...
         * 2.0之前使用quartzDataSource，2.0以后  myDS
         * 记得更改org.quartz.jobStore.dataSource
         */
        prop.put("org.quartz.dataSource.myDS.connectionProvider.class", "com.hover.common.job.model.DruidConnectionProvider");
        prop.put("org.quartz.dataSource.myDS.driver", quartzDataSourceDriver);
        prop.put("org.quartz.dataSource.myDS.URL", quartzDataSourceURL);
        prop.put("org.quartz.dataSource.myDS.user", quartzDataSourceUsername);
        prop.put("org.quartz.dataSource.myDS.password", quartzDataSourcePassword);
